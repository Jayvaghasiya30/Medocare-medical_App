...
class SpecialistOverview extends StatefulWidget {
  SpecialistOverview({this.disname});
  final String disname;
  @override
  _SpecialistOverviewState createState() => _SpecialistOverviewState();
}

class _SpecialistOverviewState extends State<SpecialistOverview> {
  @override
  initState() {
    // getdata();
    read(widget.disname);
  ...
  void read(em) {
    ...
    firestoreInstance.collection("Specialist").doc(em).get().then((value) {
      //print(value.data());
